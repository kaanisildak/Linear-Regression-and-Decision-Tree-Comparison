# -*- coding: utf-8 -*-
"""Homework_1_RegressionEND_4.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17EltdgJI0x_Tv9c1TS5kIryUuC7Ur-xs

# Homework 1

For this homework, we are going to work with [Seoul Bike Sharing Demand dataset](https://archive.ics.uci.edu/ml/datasets/Seoul+Bike+Sharing+Demand) from UCI. The homework is due Sunday, March 21st 23:30.

# Task 1

First, download the dataset. Read the dataset using pandas.read_csv function and make preliminary analysis on dataframe.
The aim in this homework is to predict Rented Bike count. You can generate your own inputs using the given features if you want. 
...
Apply another algorithm (tree-based algorithms) to your dataset. Calculate performance evaluation (RMSE, MSE, R-squared) for this model.
...
1. You must document each step of your tasks: what are you doing, why are you doing it, what problems you encountered and how you solved it. All of these must be explained and documented. 50% of your points will come from your code, while the other 50% will come from your explanations.

2. You can use MS Excel to inspect the files, but loading them up to python using pandas and inspecting them there is easier.
